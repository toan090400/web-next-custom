import BookAdminDetailPage from "../../../components/Admin/Books/detail";
...
const Book = ({ book }) => {
  ...
  return (
    <>
      <Head>
        <title>Admin Book Edit {getBook.book.name}</title>
      ...
      <LayoutAdmin>
        ...
        <BookAdminDetailPage bookData={getBook} updateData={updateData} />
      </LayoutAdmin>
    </>
  );
};
